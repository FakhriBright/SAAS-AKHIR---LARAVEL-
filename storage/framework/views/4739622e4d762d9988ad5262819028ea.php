...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="Menunggu Konfirmasi" <?php echo e(old('status_pesan') == 'Menunggu Konfirmasi' ? 'selected' : ''); ?>>Menunggu Konfirmasi</option>
                                <option value="Sedang Diproses" <?php echo e(old('status_pesan') == 'Sedang Diproses' ? 'selected' : ''); ?>>Sedang Diproses</option>
                                <option value="Menunggu Kurir" <?php echo e(old('status_pesan') == 'Menunggu Kurir' ? 'selected' : ''); ?>>Menunggu Kurir</option>
                                <option value="Selesai" <?php echo e(old('status_pesan') == 'Selesai' ? 'selected' : ''); ?>>Selesai</option>
                                <option value="Dibatalkan" <?php echo e(old('status_pesan') == 'Dibatalkan' ? 'selected' : ''); ?>>Dibatalkan</option>
                            </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\saas-akhir\resources\views/pemesanans/create.blade.php ENDPATH**/ ?>