        ...
        <div class="col-md-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('pelanggans.update', $pelanggan->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('email', $pelanggan->email)); ?>"
                                   required>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('tgl_lahir', $pelanggan->tgl_lahir?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat1"
                                      id="alamat1"
                                      class="form-control <?php $__errorArgs = ['alamat1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                      rows="2"
                                      required><?php echo e(old('alamat1', $pelanggan->alamat1)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   name="alamat2"
                                   id="alamat2"
                                   class="form-control <?php $__errorArgs = ['alamat2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   name="alamat3"
                                   id="alamat3"
                                   class="form-control <?php $__errorArgs = ['alamat3'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   name="kartu_id"
                                   id="kartu_id"
                                   class="form-control <?php $__errorArgs = ['kartu_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('kartu_id', $pelanggan->kartu_id)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('pelanggans.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\catering-online\resources\views/pelanggans/edit.blade.php ENDPATH**/ ?>