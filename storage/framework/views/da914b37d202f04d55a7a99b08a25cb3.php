    ...
    <?php if($isCOD): ?>
        ...
        <div class="alert alert-info mt-3 mb-0" style="background: #e7f3ff; border-color: #0d6efd;">
            ...
            <ol class="mb-0 mt-2" style="padding-left: 20px;">
                ...
                <li>Bayar sesuai total: <strong>Rp <?php echo e(number_format($order->total_bayar, 0, ',', '.')); ?></strong></li>
                <li>Terima bukti pembayaran dari kurir</li>
            </ol>
        </div>
    
    <?php elseif($details->count() > 0): ?>
        ...
        <div class="payment-account-item">
            <div class="account-row">
                ...
                <span class="account-value"><?php echo e($detail->tempat_bayar ?? $detail->nama_pemilik ?? '-'); ?></span>
            </div>
            <div class="account-row">
                <span class="account-label">🔢 No. Rekening</span>
                <span class="account-value rekening"><?php echo e($detail->no_rek ?? $detail->nomor_rekening ?? '-'); ?></span>
            </div>
            <?php if($detail->bank): ?>
            <div class="account-row">
