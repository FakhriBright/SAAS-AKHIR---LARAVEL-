                    ...
                    <form action="<?php echo e(route('jenis-pembayaran.store')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="metode_pembayaran" id="metode_pembayaran"
                                   class="form-control <?php $__errorArgs = ['metode_pembayaran'];
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('metode_pembayaran')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SAAS-AKHIR---LARAVEL-\resources\views/jenis-pembayaran/create.blade.php ENDPATH**/ ?>