...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('about') ? 'active' : ''); ?>" href="<?php echo e(route('about')); ?>">Tentang Kami</a></li>
                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('gallery') ? 'active' : ''); ?>" href="<?php echo e(route('gallery')); ?>">Galeri</a></li>
                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('testimoni') ? 'active' : ''); ?>" href="<?php echo e(route('testimoni')); ?>">Testimoni</a></li>
                    
                </ul>
                <div class="d-flex align-items-center gap-3">
                    <?php if(auth()->guard('pelanggan')->check()): ?>
                        
                        <a href="<?php echo e(route('customer.cart.index')); ?>" class="cart-icon text-decoration-none">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2">
                                ...
                                <li><a class="dropdown-item" href="<?php echo e(route('customer.catalog')); ?>"><i class="bi bi-grid me-2"></i>Katalog Paket</a></li>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-success btn-sm">Login</a>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-success btn-sm">Daftar</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <footer class="app-footer">
        <div class="container">
            <p class="mb-1">&copy; <?php echo e(date('Y')); ?> Fakhri Kitchen. Premium Catering Service.</p>
...
</html><?php /**PATH C:\laragon\www\SAAS-AKHIR\resources\views/layouts/app.blade.php ENDPATH**/ ?>