        ...
        <div class="catalog-main">
            ...
            <div class="product-grid" id="productGrid">
                ...
                <div class="product-card" 
                     data-category="<?php echo e(strtolower($paket->kategori)); ?>"
                     data-event="<?php echo e(strtolower($paket->jenis_acara ?? '')); ?>"
                     data-cuisine="<?php echo e(strtolower($paket->jenis_masakan ?? '')); ?>"
                     data-name="<?php echo e(strtolower($paket->nama_paket)); ?>"
                     data-price="<?php echo e($paket->harga_paket); ?>">
                    <div class="product-image">
                        <?php if($paket->foto1 && file_exists(public_path('storage/' . $paket->foto1))): ?>
                            <img src="<?php echo e(asset('storage/' . $paket->foto1)); ?>" alt="<?php echo e($paket->nama_paket); ?>">
                        <?php else: ?>
                          <?php
...
<img src="https://images.unsplash.com/<?php echo e($imageId); ?>?w=600&h=400&fit=crop" 
     ...
     onerror="this.src='https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&h=400&fit=crop'">
                        <?php endif; ?>
                        <span class="product-badge"><?php echo e($paket->jenis); ?></span>
                    </div>
                    <div class="product-body">
                        <h3 class="product-name"><?php echo e($paket->nama_paket); ?></h3>
                        <span class="product-category"><i class="bi bi-tag me-1"></i><?php echo e($paket->kategori); ?></span>
                        <p class="product-desc"><?php echo e(Str::limit($paket->deskripsi, 60)); ?></p>
                        <p class="product-pax"><i class="bi bi-people me-1"></i><?php echo e($paket->jumlah_pax); ?> Pax</p>
                        <div class="product-price">Rp <?php echo e(number_format($paket->harga_paket, 0, ',', '.')); ?></div>
                        ...
                        <form action="<?php echo e(route('customer.cart.add', $paket->id)); ?>" method="POST" class="add-to-cart-form">
                            <?php echo csrf_field(); ?>
        ...
        <div class="catalog-sidebar">
            ...
            <div class="sidebar-card">
                ...
                <div id="cartSummary" style="display: none;">
                    ...
                    <a href="<?php echo e(route('customer.checkout')); ?>" class="btn-checkout">
