                    ...
                    <form action="<?php echo e(route('detail-jenis-pembayaran.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_jenis_pembayaran" id="id_jenis_pembayaran"
                                    class="form-select <?php $__errorArgs = ['id_jenis_pembayaran'];
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__errorArgs = ['id_jenis_pembayaran'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="no_rek" id="no_rek"
                                   class="form-control <?php $__errorArgs = ['no_rek'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="tempat_bayar" id="tempat_bayar"
                                      class="form-control <?php $__errorArgs = ['tempat_bayar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                      rows="3"
                                      placeholder="Contoh: Transfer ke BCA a.n. PT Catering Sejahtera"><?php echo e(old('tempat_bayar')); ?></textarea>
                            <?php $__errorArgs = ['tempat_bayar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('detail-jenis-pembayaran.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SAAS-AKHIR---LARAVEL-\resources\views/detail-jenis-pembayaran/create.blade.php ENDPATH**/ ?>