                ...
                <div class="d-flex align-items-center gap-2">
                    <?php if(auth()->guard('pelanggan')->check()): ?>
                        ...
                        <a href="<?php echo e(route('customer.cart.index')); ?>" class="cart-icon">
                            ...
                            <?php if($count > 0): ?><span class="cart-badge"><?php echo e($count); ?></span><?php endif; ?>
                        </a>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-success btn-sm px-3 me-2" style="border-radius: 50px;">Login</a>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-success btn-sm px-3" style="border-radius: 50px;">Daftar</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="container">
            ...
            <div class="text-center">
                <small>&copy; <?php echo e(date('Y')); ?> Fakhri Kitchen. All rights reserved.</small>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\laragon\www\saas-akhir\resources\views/layouts/landing-layout.blade.php ENDPATH**/ ?>