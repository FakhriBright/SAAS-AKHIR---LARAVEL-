...
<div class="container orders-container">
    ...
    <div class="page-header">
        ...
        <a href="{{ route('customer.catalog') }}" class="btn-pesan-baru">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3>{{ $orders->where('status_pesan', 'Menunggu Konfirmasi')->count() }}</h3>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3>{{ $orders->whereIn('status_pesan', ['Sedang Diproses', 'Menunggu Kurir'])->count() }}</h3>
                <p>Dalam Proses</p>
            </div>
        </div>
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3>{{ $orders->where('status_pesan', 'Selesai')->count() }}</h3>
                <p>Selesai</p>
            </div>
        </div>
    </div>
        ...
        <div class="order-card">
            <div class="order-header">
                <div class="order-info">
                    ...
                    <div class="order-meta">
                        <span><i class="bi bi-calendar"></i> {{ $order->tgl_pesan->format('d F Y') }}</span>
                        <span><i class="bi bi-clock"></i> {{ $order->created_at->format('H:i') }} WIB</span>
                    </div>
                </div>
                <div class="order-status status-{{ strtolower(str_replace(' ', '-', $order->status_pesan)) }}">
            ...
            <div class="order-items">
                ...
                <div class="order-item">
                    <div>
                        ...
                        <div class="item-qty">{{ $detail->jumlah }} x Rp {{ number_format($detail->paket->harga_paket, 0, ',', '.') }}</div>
                    </div>
            ...
            <div class="order-footer">
                ...
                <div class="order-actions">
                    <a href="{{ route('customer.order.show', $order->id) }}" class="btn-order primary">
