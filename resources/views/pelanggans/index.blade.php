...
<div class="row mb-4">
    ...
    <div class="col-md-6 text-md-end">
        <a href="{{ route('pelanggans.create') }}" class="btn btn-primary rounded-pill px-4">
        ...
        <table class="table table-modern mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-muted small">{{ Str::limit($pelanggan->alamat1, 40) }}</td>
                    <td class="text-end pe-4">
                        <div class="btn-group">
                            <a href="{{ route('pelanggans.edit', $pelanggan->id) }}" class="btn btn-sm btn-light text-primary"><i class="bi bi-pencil"></i></a>
                            <form action="{{ route('pelanggans.destroy', $pelanggan->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus pelanggan?')">
                                @csrf @method('DELETE')
